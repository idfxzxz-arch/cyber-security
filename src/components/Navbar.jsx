...
function navClass({ isActive }) {
  return `inline-flex min-h-10 items-center whitespace-nowrap rounded-lg px-3 py-2 text-sm font-semibold leading-none transition ${isActive ? 'bg-blue-950 text-white' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-950'}`
}
